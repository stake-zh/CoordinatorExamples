...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.main_coordinator_textview1).setOnClickListener(this);
        findViewById(R.id.main_materialup_textview).setOnClickListener(this);
        findViewById(R.id.main_materialup_textview1).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.main_coordinator_textview:
                ...
                break;
            case R.id.main_coordinator_textview1:
                SimpleCoordinatorActivity1.start(this);
                break;
            ...
            case R.id.main_materialup_textview:
                MaterialUpConceptActivity1.start(this);
                break;
            case R.id.main_materialup_textview1:
                MaterialUpConceptActivity1.start(this);
                break;
